...
public class SeriesCalculator {
     ...
     *
     * @param n The number of terms in the series. Must be greater than or equal to 0.
     ...
     * @throws IllegalArgumentException if n is less than 0 or precision is less than or equal to 1.
     */
